...
<head>
    ...
    <link rel="stylesheet" href="Vista/css/Recuperar_password.css">
</head>
<body>
    <!-- Header -->
    <header>
    ...
    <main>
        <div class="container login-container">
            <div class="page-title">
                ...
                <p>Ingresa tus credenciales para recuperar tu cuenta</p>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <label class="radio-option">
                                <input type="radio" name="user-type" value="edificios" checked>
                                <span class="radio-label">Residente</span>
                            </label>
                            
                            <label class="radio-option">
                                <input type="radio" name="user-type" value="presidente_condominio">
