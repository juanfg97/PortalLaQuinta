        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p>Mantente informado sobre todas las noticias y eventos importantes del edificio <?php echo $_SESSION['edificiocompleto']; ?></p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <?php  include '../../Controlador/funciones/mostrarinfoEdificio.php';  ?>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="stats-card">
                        <div class="stat-number" id="totalAnnouncements"> <?php    
