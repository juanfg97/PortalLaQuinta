...
$query = "SELECT password FROM presidente_central WHERE usuario = ?";
...
try {
    ...
    $stmt = $conexion->prepare("UPDATE presidente_central SET  password= ?, ultima_modificacion=? WHERE usuario = ?");
    if (!$stmt) {
