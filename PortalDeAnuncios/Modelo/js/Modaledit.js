...
function saveName() {
    ...
    if(!REGEX_NOMBRE_VALIDO.test(name)){
        ...
        showErrorMessage('El nombre solo puede contener letras, espacios y apostrofes');
        return;
    }

    fetch('../../Controlador/guardados/guardarnombre.php', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.success) {
            document.querySelector('.info-item:nth-child(1) .info-value').textContent = name;
...
function saveEmail() {
    ...
    fetch('../../Controlador/guardados/guardarcorreo.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function savePhone() {
    ...
    if(!REGEX_TELEFONO_VALIDO.test(phone)){
       ...
       fetch('../../Controlador/guardados/guardartelefono.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function savePassword() {
   ...
   fetch('../../Controlador/guardados/guardarpassword.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
